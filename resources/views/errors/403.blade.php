<x-app-layout title="403 - Akses Ditolak">
    <div class="min-h-[85vh] flex items-center justify-center relative overflow-hidden py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="absolute -bottom-40 -right-40 w-96 h-96 bg-red-500/10 rounded-full blur-3xl pointer-events-none animate-pulse"></div>
        ...
        <div class="absolute inset-0 pointer-events-none overflow-hidden select-none">
            ...
            <div class="animate-float text-amber-500/40" style="position: absolute; top: 15%; left: 6%;">
                <svg class="w-12 h-12 sm:w-16 sm:h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                </svg>
            </div>
            
            <div class="animate-float-delayed text-emerald-500/40" style="position: absolute; top: 48%; left: 4%;">
                <svg class="w-14 h-14 sm:w-18 sm:h-18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                </svg>
            </div>

            <div class="animate-float-reverse text-amber-500/35" style="position: absolute; top: 78%; left: 8%;">
            ...
            <div class="animate-float-delayed text-amber-400/30 hidden md:block" style="position: absolute; top: 12%; left: 28%;">
            ...
            <div class="animate-float-reverse text-red-500/35" style="position: absolute; top: 18%; right: 7%;">
                <svg class="w-12 h-12 sm:w-16 sm:h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                </svg>
            </div>

            <div class="animate-float text-emerald-500/40" style="position: absolute; top: 52%; right: 5%;">
                <svg class="w-14 h-14 sm:w-18 sm:h-18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                </svg>
            </div>
            ...
            <div class="animate-float text-red-400/30 hidden md:block" style="position: absolute; top: 12%; right: 28%;">
                <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                </svg>
            </div>
        ...
        <div class="max-w-xl w-full text-center relative z-10 flex flex-col items-center justify-center space-y-6 sm:space-y-8">
            ...
            <!-- 403 Header Badge & Big Number -->
            <div class="flex flex-col items-center justify-center space-y-4">
                <h1 class="font-extrabold tracking-widest text-amber-500 dark:text-amber-400 drop-shadow-lg leading-none select-none" style="font-size: clamp(4.5rem, 10vw, 8rem); line-height: 1;">
                    403
                </h1>
                <div class="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-amber-500/10 dark:bg-amber-950/80 border border-amber-500/30 text-amber-600 dark:text-amber-400 text-xs sm:text-sm font-bold shadow-sm backdrop-blur-md">
            ...
            <div class="space-y-3 max-w-lg">
                <h2 class="text-2xl sm:text-3xl font-extrabold text-on-surface">
                    Area Khusus Petugas / Admin
                </h2>
                <p class="text-on-surface-variant text-sm sm:text-base leading-relaxed">
                    Maaf, Anda tidak memiliki hak akses untuk membuka halaman ini. Silakan kembali ke dashboard akun Anda.
                </p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3 w-full sm:w-auto pt-2">
                <button onclick="window.history.back()" 
                        class="w-full sm:w-auto min-w-[150px] px-6 py-3.5 rounded-xl bg-surface-container-high hover:bg-surface-container-highest text-on-surface font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2 border border-outline-variant hover:scale-105 active:scale-95 shadow-sm whitespace-nowrap">
