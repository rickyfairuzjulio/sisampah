...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-on-surface">Tambah Pengguna Baru</h1>
        <p class="text-on-surface-variant">Buat akun untuk Petugas atau Nasabah.</p>
    </div>
    ...
    <x-card>
        <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-on-surface mb-2">Password <span class="text-red-500">*</span></label>
