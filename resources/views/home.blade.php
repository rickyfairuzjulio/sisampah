...
{{-- ═══════════════ FITUR BENTO ═══════════════ --}}
<section id="fitur" class="py-16 sm:py-20 lg:py-28">
...
{{-- ═══════════════ CARA KERJA ═══════════════ --}}
<section id="cara-kerja" class="py-16 sm:py-20 lg:py-28 bg-[#0a1f17]/50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-12 lg:mb-16">
...
{{-- ═══════════════ DAMPAK / STATS ═══════════════ --}}
<section id="dampak" class="py-16 sm:py-20 lg:py-28">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
{{-- ═══════════════ EDUKASI ═══════════════ --}}
@if($articles->count())
<section class="py-16 sm:py-20 lg:py-28 bg-[#0a1f17]/50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
