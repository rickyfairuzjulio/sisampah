...
export default function SuperAdminHeroBanner({
    ...
    return (
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#047857] via-[#115E59] to-[#0F172A] text-white shadow-md p-6 sm:p-8 animate-slide-in select-none">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div className="space-y-3 max-w-2xl">
                    ...
                    <div className="pt-2 flex flex-wrap items-center gap-3">
                        ...
                        <a
                            ...
                            className="px-4 py-2.5 bg-white/15 hover:bg-white/25 text-white border border-white/20 rounded-xl font-bold text-xs transition-all shadow-sm flex items-center gap-2 cursor-pointer hover:scale-105 active:scale-95"
                        >
                ...
                <div className="p-5 rounded-2xl bg-black/30 backdrop-blur-md border border-white/15 grid grid-cols-2 gap-4 shrink-0 shadow-lg min-w-[280px]">
