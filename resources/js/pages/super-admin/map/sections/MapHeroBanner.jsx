            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div className="space-y-2.5 max-w-2xl">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-400/30 text-emerald-200 text-xs font-extrabold uppercase tracking-wider backdrop-blur-xs">
                        <span>🗺️</span>
                        <span>Sistem Informasi Geospasial (GIS)</span>
                    </div>

                    <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-white flex items-center gap-3">
                        <span>Peta Sebaran Bank Sampah Nasional</span>
                        <span>🗺️</span>
                    </h1>

                    <p className="text-xs sm:text-sm text-emerald-100/90 leading-relaxed">
                        Visualisasi persebaran geografis, analisis radius jangkauan layanan jemput armada (Service Coverage Area), dan identifikasi zona blank spot di seluruh Indonesia.
                    </p>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3 shrink-0">
                    ...
                    >
                        <i className="bi bi-building text-emerald-300" />
                    ...
                    >
                        <i className="bi bi-shield-check text-slate-950 text-sm" />
