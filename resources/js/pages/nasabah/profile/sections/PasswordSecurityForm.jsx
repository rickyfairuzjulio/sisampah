            ...
            >
                ...
                <div>
                    <label htmlFor="current_password" className="block text-xs font-bold text-slate-700 mb-1.5">
                        Kata Sandi Saat Ini <span className="text-emerald-600">*</span>
                    </label>
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full pl-10 pr-12 py-2.5 sm:py-3 bg-white text-slate-900 text-xs sm:text-sm font-medium border rounded-xl outline-none transition-all ${
                    ...
                    {currentPasswordError && (
                        <p className="mt-1 text-xs font-semibold text-red-500">{currentPasswordError}</p>
                    )}
                </div>

                {/* 2. Grid Sandi Baru & Konfirmasi */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    
                    {/* Kata Sandi Baru */}
                    <div>
                        <label htmlFor="password" className="block text-xs font-bold text-slate-700 mb-1.5">
                            Kata Sandi Baru <span className="text-emerald-600">*</span>
                        </label>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                                <Lock className="w-4 h-4" />
                    ...
                    <div>
                        <label htmlFor="password_confirmation" className="block text-xs font-bold text-slate-700 mb-1.5">
                            Konfirmasi Sandi Baru <span className="text-emerald-600">*</span>
                        </label>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                                <Lock className="w-4 h-4" />
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-12 py-2.5 sm:py-3 bg-white text-slate-900 text-xs sm:text-sm font-medium border border-slate-200 rounded-xl focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none transition-all"
                            />
                            <button
                                type="button"
                ...
                <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200 text-xs text-slate-600 flex items-start gap-2.5">
                    ...
                    <span>
                        <strong>Tips Keamanan:</strong> Gunakan minimal 8 karakter kombinasi huruf besar, huruf kecil, angka, dan simbol unik.
                    </span>
                </div>
