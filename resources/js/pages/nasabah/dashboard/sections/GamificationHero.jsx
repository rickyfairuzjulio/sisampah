...
export default function GamificationHero({ authData = {}, gamification = {} }) {
    ...
    return (
        <section className="bg-white border border-slate-200 rounded-2xl p-5 sm:p-6 shadow-sm flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-4 w-full md:w-auto">
                <div className="relative shrink-0">
                    ...
                    <span className="absolute -bottom-2 -right-1.5 bg-slate-900 text-white text-[10px] font-black px-2 py-0.5 rounded-full border border-slate-700 shadow-sm">
                        LV {level}
                    </span>
                </div>

                <div className="space-y-1 min-w-0">
                    <div className="inline-flex items-center gap-1.5 bg-emerald-50 text-emerald-700 px-2.5 py-0.5 rounded-full text-xs font-bold border border-emerald-100">
            ...
            <div className="w-full md:w-80 bg-slate-50 border border-slate-200/80 rounded-xl p-3.5 space-y-2">
                ...
                <div className="flex justify-between items-center text-[10px] text-slate-400 font-medium">
                    ...
                    {level < 4 ? (
                        ...
                        <span className="text-emerald-600 font-bold">Maksimal Level 🎉</span>
                    )}
                </div>
            </div>
