        ...
        <aside className="h-full w-[260px] bg-white dark:bg-[#0D131F] border-r border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between select-none transition-colors duration-200">
            ...
            <div>
                ...
                <div className="h-16 flex items-center justify-between px-6 border-b border-slate-100 dark:border-slate-800">
                    <Link href="/petugas/dashboard" className="flex items-center gap-2.5 group">
                        <img 
                            src="/images/logo.png" 
                            alt="SiSampah Logo" 
                ...
                <div className="p-4 mx-3 my-3 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50/60 dark:from-emerald-950/40 dark:to-slate-900 border border-emerald-100/80 dark:border-slate-800 shadow-2xs">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                            ...
                            <div className="flex items-center gap-1 text-[10px] text-emerald-800 dark:text-emerald-400 font-semibold mt-0.5 truncate">
                        ...
                        return (
                            <Link
                                ...
                                className={`flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all relative ${
                                    isActive
                                        ? 'bg-emerald-50 dark:bg-emerald-950/40 text-emerald-800 dark:text-emerald-300 border-l-4 border-emerald-600 dark:border-emerald-500 shadow-2xs'
            ...
            <div className="p-3 border-t border-slate-100 dark:border-slate-800 space-y-2">
                <a
                    href="/"
                    className="flex items-center justify-center gap-2 w-full py-2 px-3 bg-slate-50 dark:bg-slate-800/80 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white rounded-xl font-bold text-xs transition-colors border border-slate-200/80 dark:border-slate-700 shadow-2xs cursor-pointer"
                >
